...
`/ticket-issue` や `/ticket-pr` で Issue・PR を上げる、PR を経由せず commit を push する、書いた docs や README を直接 push する——外部公開につながる操作は今後も増える。どこかで秘密鍵や個人情報を載せてしまうと、GitHub 上で公開・キャッシュ・インデックスされ、コミット履歴から消しても他者の clone や通知メールに残る。出した後の回収はできない前提で、これを人手の注意ではなく機械的なゲートで止める。
